...
public class OrganizationService {
	...
	public Organization createOrganization(OrganizationPayload org_payload) {
		...
		Organization new_org = new Organization(org_payload.getName(), org_payload.getSeo_name(), org_payload.getLogo_url(), org_payload.getMission(), org_payload.getVision(), org_payload.getAddress(), org_payload.getSocial_network_url(), country, contact);
